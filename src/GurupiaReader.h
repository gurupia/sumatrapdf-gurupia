...
constexpr const char* kWebsiteURL = "https://www.GurupiaReaderreader.org/";
constexpr const char* kManualURL = "https://www.GurupiaReaderreader.org/manual";
constexpr const char* kContributeTranslationsURL = "https://www.GurupiaReaderreader.org/docs/Contribute-translation";

#ifndef CRASH_REPORT_URL
#define CRASH_REPORT_URL "https://www.GurupiaReaderreader.org/docs/Contribute-to-GurupiaReader"
#endif
...
// permissions that can be revoked through GurupiaReaderrestrict.ini or the -restrict command line flag
enum class Perm : uint {
    ...
    All = 0x0FFFFFF,
    // set if either GurupiaReaderrestrict.ini or the -restrict command line flag is present
...
// all defined in GurupiaReader.cpp
extern Flags* gCli;
