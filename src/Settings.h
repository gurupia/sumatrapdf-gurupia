...
// for more
// information](https://www.GurupiaReaderreader.org/docs/Customize-external-viewers)
...
// information](https://www.GurupiaReaderreader.org/docs/Customize-search-translation-services)
...
struct FileState {
    ...
    Vec<int>* tocState;
    // thumbnails are saved as PNG files in GurupiaReadercache directory
...
// Preferences are persisted in GurupiaReader-settings.txt
struct GlobalPrefs {
    ...
    // if true, Esc key closes GurupiaReader
    bool escToExit;
    ...
    // at startup
    bool restoreSession;
    // if true, we'll always open files using existing GurupiaReader process
    bool reuseInstance;
...
static const FieldInfo gGlobalPrefsFields[] = {
    {(size_t)-1, SettingType::Comment,
     (intptr_t)"For documentation, see https://www.GurupiaReaderreader.org/settings/settings3-6.html"},
